...
- Environment variables setup
  ...
  - Backend `.env.local` template
    ...
    CORS_ALLOWED_ORIGINS=http://10.45.144.198 http://localhost http://127.0.0.1
    CSRF_TRUSTED_ORIGINS=http://10.45.144.198 http://localhost http://127.0.0.1
...
<table>
  <tr>
    ...
    <td align="center"><a href="https://github.com/p4nk1d"><img src="https://avatars.githubusercontent.com/u/71972700?v=4?s=100" width="150px;" alt=""/><br /><sub><b>p4nk1d</b></sub></a><br /><a href="https://github.com/ducluongtran9121/Web-Application-Project/commits?author=thihuynhdotexe" title="Code">💻</a> <a href="#maintenance-thihuynhdotexe" title="Maintenance">🚧</a> <a href="#projectManagement-thihuynhdotexe" title="Project Management">📆</a></td>
